...
test-templates: test-go test-node test-python test-quarkus test-rust test-springboot test-typescript ## Run all template tests
...
test-springboot: ## Test Springboot templates
